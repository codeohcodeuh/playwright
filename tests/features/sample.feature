...
The login
  ...
  Scenario: Navigate to the application
    ...
    Then the user verifies the Connections page as a admin
    # Then the user verifies the Connections page as a parent
    # Then the user verifies the Connections page as a user