...
test.describe('Login functionality', () => {
  ...
  test('Navigate to the application', { tag: ['@env=\'QA\'', '@App=\'AeriaLink\'', '@data={\'AeriaLink.MCH.Niche.00002\',\'AeriaLink.MCH.Niche.00003\'}'] }, async ({ Given, When, Then, page }) => { 
    ...
    await Then('the user verifies the Connections page as a admin', null, { page }); 
  });
